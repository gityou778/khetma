...
self.addEventListener('fetch', (event) => {
  ...
  // ملفات MP3 الخارجية الضخمة: تمرر مباشرة إلى الشبكة دون حجز الذاكرة
  ...
  // لطلبات صفحات التنقل (HTML Navigation): Network-first مع Fallback للكاش
  ...
  // أصول التطبيق الثابتة: Stale-While-Revalidate
  event.respondWith(
